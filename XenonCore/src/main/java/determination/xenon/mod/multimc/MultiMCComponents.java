...
public final class MultiMCComponents {
    ...
    static {
        ...
        // Check whether MultiMCComponents is 'determination.xenon.mod.multimc.MultiMCComponents'.
        ...
        if (new String(
            ...
            INSTALLER_PROFILE.put("Implementation", "Probably vanilla. Class location is not modified (determination.xenon.mod.multimc.MultiMCComponents).");
        } else {
