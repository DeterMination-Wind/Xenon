 ...
 */
package determination.xenon.mod.multimc;

import com.google.gson.JsonParseException;
import com.google.gson.annotations.SerializedName;
import determination.xenon.download.LibraryAnalyzer;
import determination.xenon.game.Argument;
import determination.xenon.game.Arguments;
import determination.xenon.game.Artifact;
import determination.xenon.game.AssetIndexInfo;
import determination.xenon.game.CompatibilityRule;
...
import determination.xenon.game.OSRestriction;
import determination.xenon.game.RuledArgument;
import determination.xenon.game.StringArgument;
...
import determination.xenon.util.gson.JsonMap;
...
public final class MultiMCInstancePatch {
    public static final Library BOOTSTRAP_LIBRARY = new Library(new Artifact("determination.xenon", "mmc-bootstrap", "1.0"));
    ...
    public static ResolvedInstance resolveArtifact(List<MultiMCInstancePatch> patches, String versionID) {
...

        {
            ...
            mainClass = "determination.xenon.HMCLMultiMCBootstrap";
        }
