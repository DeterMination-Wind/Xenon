 ...
 */
package determination.xenon.auth.microsoft;

import com.google.gson.Gson;
import com.google.gson.GsonBuilder;
import com.google.gson.JsonParseException;
import com.google.gson.annotations.SerializedName;
import determination.xenon.auth.AuthenticationException;
import determination.xenon.auth.OAuth;
import determination.xenon.auth.ServerDisconnectException;
import determination.xenon.auth.ServerResponseMalformedException;
import determination.xenon.auth.yggdrasil.CompleteGameProfile;
import determination.xenon.auth.yggdrasil.RemoteAuthenticationException;
import determination.xenon.auth.yggdrasil.Texture;
import determination.xenon.auth.yggdrasil.TextureType;
import determination.xenon.util.StringUtils;
import determination.xenon.util.gson.*;
import determination.xenon.util.io.*;
import determination.xenon.util.javafx.ObservableOptionalCache;
