 ...
 */
package determination.xenon.download.java.disco;
...
import static determination.xenon.download.java.JavaPackageType.*;
import static determination.xenon.util.Pair.pair;
import static determination.xenon.util.platform.Architecture.*;
import static determination.xenon.util.platform.OperatingSystem.*;
