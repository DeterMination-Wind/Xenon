...
import determination.xenon.util.io.UrlResponseInfo;
...
import static determination.xenon.util.gson.JsonUtils.*;
...
public class CacheRepository {
    ...
    /// Ensures the cache key is a concrete SHA-1 digest before using it as a cache filename.
