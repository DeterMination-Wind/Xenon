...
import determination.xenon.auth.offline.Skin;
import determination.xenon.auth.yggdrasil.*;
import determination.xenon.task.FileDownloadTask;
import determination.xenon.task.Schedulers;
import determination.xenon.ui.FXUtils;
import determination.xenon.util.Holder;
...
public final class TexturesLoader {
    ...
    private static final Path TEXTURES_DIR = Metadata.XENON_GLOBAL_DIRECTORY.resolve("skins");
