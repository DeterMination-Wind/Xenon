...
import determination.xenon.countly.CrashReport;
import determination.xenon.ui.CrashWindow;
...
public final class CrashReporter implements Thread.UncaughtExceptionHandler {
    ...
    private static final class Hole {
        ...
        static final Pair<String, String>[] SOURCE = (Pair<String, String>[]) new Pair<?, ?>[]{
                ...
                pair("determination.xenon.util.ResourceNotFoundError", i18n("crash.NoClassDefFound")),
