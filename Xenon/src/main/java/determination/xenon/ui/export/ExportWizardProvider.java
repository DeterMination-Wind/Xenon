 ...
 */
package determination.xenon.ui.export;

import javafx.scene.Node;
import determination.xenon.Metadata;
import determination.xenon.mod.ModAdviser;
import determination.xenon.mod.ModpackExportInfo;
...
import determination.xenon.setting.Config;
import determination.xenon.setting.FontManager;
...
import determination.xenon.util.io.Zipper;
        ...
        return new Task<>() {
            ...
            public void execute() throws Exception {
                ...
                try (Zipper zip = new Zipper(modpackFile)) {
                    ...
                    zip.putTextFile(exported.toJson(), ".xenon/xenon.json");
                    zip.putFile(tempModpack, ModpackTypeSelectionPage.MODPACK_TYPE_MODRINTH.equals(modpackType)
                            ? "modpack.mrpack"
                            : "modpack.zip");

                    Path bg = Metadata.XENON_CURRENT_DIRECTORY.resolve("background");
                    ...
                    for (String extension : FXUtils.IMAGE_EXTENSIONS) {
                        ...
                        Path background = Metadata.XENON_CURRENT_DIRECTORY.resolve(fileName);
                    ...
                    for (String extension : FontManager.FONT_EXTENSIONS) {
                        ...
                        Path font = Metadata.XENON_CURRENT_DIRECTORY.resolve(fileName);
