...
import determination.xenon.mod.LocalModFile;
import determination.xenon.mod.ModLoaderType;
import determination.xenon.mod.RemoteMod;
import determination.xenon.mod.RemoteModRepository;
...
import determination.xenon.util.Lazy;
import determination.xenon.util.Pair;
...
import static determination.xenon.ui.FXUtils.ignoreEvent;
import static determination.xenon.ui.FXUtils.onEscPressed;
import static determination.xenon.ui.ToolbarListPageSkin.createToolbarButton2;
                        ...
                        if (versionOptional.isPresent()) {
                            ...
                            FXUtils.runInFX(() -> {
                                ...
                                button.setOnAction(e -> {
                                    ...
                                    // Xenon: forward to the Mindustry mod browser instead
                                    // of HMCL's CurseForge/Modrinth UI.
