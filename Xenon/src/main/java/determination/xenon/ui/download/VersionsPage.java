...
import determination.xenon.download.cleanroom.CleanroomRemoteVersion;
import determination.xenon.download.fabric.FabricAPIRemoteVersion;
import determination.xenon.download.fabric.FabricRemoteVersion;
import determination.xenon.download.forge.ForgeRemoteVersion;
import determination.xenon.download.game.GameRemoteVersion;
import determination.xenon.download.legacyfabric.LegacyFabricAPIRemoteVersion;
import determination.xenon.download.legacyfabric.LegacyFabricRemoteVersion;
import determination.xenon.download.liteloader.LiteLoaderRemoteVersion;
import determination.xenon.download.neoforge.NeoForgeRemoteVersion;
import determination.xenon.download.optifine.OptiFineRemoteVersion;
import determination.xenon.download.quilt.QuiltAPIRemoteVersion;
import determination.xenon.download.quilt.QuiltRemoteVersion;
...
import determination.xenon.ui.animation.ContainerAnimations;
