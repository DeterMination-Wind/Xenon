...
import determination.xenon.upgrade.UpdateHandler;
...
import static determination.xenon.util.DataSizeUnit.MEGABYTES;
...
public final class Launcher extends Application {
    ...
    private static void checkConfigOwner() {
        ...
        if (Files.exists(Metadata.XENON_GLOBAL_DIRECTORY))
            files.add(Metadata.XENON_GLOBAL_DIRECTORY.toString());
        if (Files.exists(Metadata.XENON_CURRENT_DIRECTORY))
            files.add(Metadata.XENON_CURRENT_DIRECTORY.toString());
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            LOG.info("Xenon Global Directory: " + Metadata.XENON_GLOBAL_DIRECTORY);
            LOG.info("Xenon Current Directory: " + Metadata.XENON_CURRENT_DIRECTORY);
            LOG.info("Xenon Jar Path: " + Lang.requireNonNullElse(JarUtils.thisJarPath(), "Not Found"));
            LOG.info("Xenon Log File: " + Lang.requireNonNullElse(LOG.getLogFile(), "In Memory"));
