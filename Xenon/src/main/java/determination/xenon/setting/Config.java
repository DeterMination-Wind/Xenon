...
import determination.xenon.theme.ThemeColor;
...
public final class Config extends ObservableSetting {
    ...
    private final StringProperty commonDirectory = new SimpleStringProperty(Metadata.XENON_GLOBAL_DIRECTORY.toString());
