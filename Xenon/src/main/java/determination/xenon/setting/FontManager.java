...
public final class FontManager {
    ...
    private static final Lazy<Font> DEFAULT_FONT = new Lazy<>(() -> {
        ...
        font = tryLoadLocalizedFont(Metadata.XENON_CURRENT_DIRECTORY.resolve("font"));
        if (font != null)
            return font;

        font = tryLoadLocalizedFont(Metadata.XENON_GLOBAL_DIRECTORY.resolve("font"));
        if (font != null)
            return font;

        // Legacy

        font = tryLoadDefaultFont(Metadata.XENON_CURRENT_DIRECTORY);
        if (font != null)
            return font;
        ...
        font = tryLoadDefaultFont(Metadata.XENON_GLOBAL_DIRECTORY);
        if (font != null)
            return font;
